...
namespace Kuretan.AvatarTextTools.Settings
{
	public class KatSettings
	{
		public readonly string ParamTextVisible = "KAT_Visible";
		public readonly string ParamTextLoading = "KAT_Loading";
		...
		public readonly int TextLength = 256;
		...
		public KatSettings(bool installKeyboard = true, int attachmentPoint = KatAttachmentPoint.Chest, int syncParamsSize = 4, int textLength = 128)
		{
